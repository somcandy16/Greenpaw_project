    ...
    <div class="main">
      ...
      <div class="content_wrap">
          ...
          <div class="write_box_bg">
            ...
            <ul class="sub_title">
              ...
              <ul class="content_title">
                <li class="type_select"><input type="radio" id="type" name="type" id="plant" checked value="plant" /><label for="plant">plant</label></li>
                <li class="type_select"><input type="radio" id="type" name="type" id="pet" value="pet" /><label for="pet">pet</label></li>
                <li class="title_input">
        ...
        <div class="album_right">
          <ul class="menu">
            <li class="list">
              <a href="./Thumbnail_board.jsp">list</a>
            </li>
            <li class="new">
              <a href="#">new</a>
            </li>
